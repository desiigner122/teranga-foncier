      ...
      const loadUserListings = async () => {
        ...
        try {
          ...
          setListings([
            ...
            { 
              id: 'PROP003', 
              name: 'Terrain agricole proche Thiés', 
              type: 'agricultural', 
              status: 'rejected', 
        ...
        <div className="space-y-4">
                      ...
                      <CardContent>
                          ...
                          {listing.status === 'Vendu (Paiement en cours)' && (
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Montant peréu: {formatPrice(listing.totalPaid)}</p>
                            </div>
                          )}
                      </CardContent>
                         ...
                         <AlertDialog>
                           ...
                           <AlertDialogContent>
                             <AlertDialogHeader>
                               ...
                               <AlertDialogDescription>
                                 étes-vous sér de vouloir supprimer définitivement ce bien ({listing.name}) ? Cette action est irréversible.
                               </AlertDialogDescription>
                             </AlertDialogHeader>
                             <AlertDialogFooter>
         ...
         >
             ...
             <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Vous n'avez pas encore proposé de bien é la vente sur notre plateforme.
             </p>
             <Button asChild>
