        ...
        >
            ...
            <CardContent>
                ...
                <div className="mb-3 p-3 bg-muted/50 rounded border text-sm">
                    ...
                    <p className="text-xs text-muted-foreground">{parcelDetails.zone} - {parcelDetails.area_sqm} mé</p>
                </div>
                ) : (
                <div className="mb-3 p-3 bg-muted/50 rounded border text-sm">
                     <p className="font-semibold mb-1">Demande auprés de : {request.recipient}</p>
                </div>
                )}
