    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="hover:shadow-lg transition-shadow border-l-4 border-red-500">
          ...
          <CardContent>
            <p className="text-xl font-bold">{actorStats.vendeur.parcellesListees} <span className="text-sm text-muted-foreground">parcelles listées</span></p>
        ...
        <Card className="hover:shadow-lg transition-shadow border-l-4 border-cyan-500">
          ...
          <CardContent>
            <p className="text-xl font-bold">{actorStats.particulier.demandesSoumises} <span className="text-sm text-muted-foreground">demandes soumises</span></p>
        ...
        <Card className="hover:shadow-lg transition-shadow border-l-4 border-teal-500">
          <CardHeader><CardTitle className="text-sm font-medium flex items-center"><UserCheck className="mr-2 h-4 w-4"/>Agents</CardTitle></CardHeader>
          <CardContent>
