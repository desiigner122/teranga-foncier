...
const { toast } = useToast();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        title: "Demande créée",
        description: `Votre demande a été envoyée é ${formData.type === 'terrain_communal' ? 'la mairie' : 'la banque'} concernée. Vous recevrez une notification dés qu'elle sera traitée.`
      });
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Votre demande sera directement envoyée é cette mairie
                </p>
              </div>
              ...
              <div>
                <Label htmlFor="surface">Surface souhaitée (mé)</Label>
                <Input
                  id="surface"
                  type="number"
          ...
          return (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Votre demande de financement sera directement envoyée é cette banque
                </p>
              </div>

              <div>
                <Label htmlFor="parcel_id">Terrain é financer *</Label>
                  ...
                  <SelectContent>
                    {userParcels.map((parcel) => (
                      <SelectItem key={parcel.id} value={parcel.id}>
                        {parcel.reference} - {parcel.name} ({parcel.surface_area}mé)
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Ex: Fonctionnaire, Commeréant, etc."
                />
              </div>
            </div>
          );
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            {step === 3 && "Complétez les informations spécifiques é votre demande"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {renderStepContent()}
