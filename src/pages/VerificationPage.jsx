...
const VerificationPage = () => {
  ...
  if (profile?.verification_status === 'verified') {
    return (
      <>
        <Helmet>
          <title>Vérification Complète - Teranga Foncier</title>
        </Helmet>
        <motion.div 
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1 }} 
        ...
        >
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription>Votre compte est déjà vérifié et opérationnel.</CardDescription>
            </CardHeader>
          ...
          {step === 3 && (
            <Card className="shadow-xl">
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">Documents envoyés avec succès !</h3>
