...
const { user, profile } = useAuth();
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Calculer le progrés de construction moyen
  ...
  const generateAIInsights = async () => {
    try {
      ...
      const query = `En tant qu'expert en promotion immobiliére au Sénégal, analyse ma performance:
      ...
      Fournis 3 recommandations stratégiques pour optimiser mes projets et identifier 2 risques potentiels é surveiller.`;
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge className={`text-xs ${
                        risk.impact === 'Trés élevé' ? 'bg-red-100 text-red-800' :
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge className={milestone.onTime ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                        {milestone.onTime ? 'é temps' : 'Retard'}
                      </Badge>
