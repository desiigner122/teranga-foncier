...
import { DollarSign, Eye, Search, AlertCircle, CheckCircle, Clock, TrendingUp } from 'lucide-react';
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    {transactions.length === 0 
                      ...
                      : "Aucune transaction ne correspond é vos critéres de recherche."
                    }
                  </p>
                </CardContent>
              </Card>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                {method.last_digits ? `éééé ${method.last_digits}` : method.description}
                              </p>
                            </div>
                          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Les graphiques et analyses détaillées seront bientét disponibles.
                </p>
              </div>
            </CardContent>
          </Card>
