...
const NotairesDashboard = () => {
  ...
  const authenticateDossier = async (dossier) => {
    ...
    try {
      ...
      // Mettre é jour la transaction comme authentifiée
...
En tant qu'expert notaire, effectue une analyse compléte:
...
Fournis une réponse structurée avec score et recommandations.`;
      ...
      // Calcul du score de risque basé sur des critéres réels
      let riskScore = 0;
      ...
      setDocumentAnalysis({
        ...
        result: response,
        riskScore: Math.min(100, riskScore), // Cap é 100
        timestamp: new Date(),
        analysisDetails: {
          completeness: !dossier.valuation ? 'Incompléte' : 'Compléte',
  ...
  const handleDecision = async (decision) => {
    if (currentDossier) {
      try {
        ...
        // Mise é jour dans la table transactions
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4">
                  <p className="text-center text-muted-foreground">
                    Calendrier des consultations é venir
                  </p>
                </div>
              </div>
            </CardContent>
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Gestion des actes notariés et vérifications fonciéres</p>
      </div>
