...
const { toast } = useToast();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Upload paralléle avec suivi simple (incrémente sur chaque résolution)
      ...
      <Card className="shadow-xl border-border/50 bg-card">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-lg text-muted-foreground">
            Sélectionnez la localisation, précisez votre projet et joignez vos piéces justificatives.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label>Superficie souhaitée (mé)</Label>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Minimum 20 caractéres.</p>
                </div>
            ...
            {step === 3 && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold flex items-center gap-2"><UploadCloud className="h-5 w-5 text-primary" /> Piéces Jointes</h3>
                <p className="text-sm text-muted-foreground">Ajoutez les documents requis (PDF, JPG, PNG, max 5MB). Recommandé: Piéce identité, justificatif domicile, plan sommaire, financement.</p>
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <div className="bg-muted/40 rounded-md p-4 space-y-3 text-sm">
                  ...
                  <div><strong>Superficie demandée:</strong> {formData.areaSqm} mé</div>
