    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">Identifiez le type de terrain, la localisation et la surface souhaités. Notre plateforme vous aide é affiner votre recherche.</p>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">Pour soumettre une demande officielle, vous devez étre un utilisateur enregistré sur Teranga Foncier.</p>
          {!isAuthenticated && (
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">Accédez é votre tableau de bord et remplissez le formulaire de demande de terrain auprés de la mairie de votre choix.</p>
        </motion.div>
      </div>
      ...
      >
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Prét é faire votre demande ?</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Cliquez ci-dessous pour accéder au formulaire de demande de terrain en mairie. Vous serez redirigé vers la page de connexion si vous n'étes pas déjé authentifié.
        </p>
