...
const ProtectedRoute = ({ 
  ...
  if (loading) {
    // Affiche un spinner tant que l'authentification et le profil ne sont pas complétement chargés
    return (
  ...
  // Nouvelle logique : on autorise l'accés si statut pending; on ne bloque que si explicitement 'rejected' ou needsVerification (aucun dossier)
