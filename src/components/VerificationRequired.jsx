...
const VerificationRequired = () => {
  ...
  // Vérifier si l'utilisateur a déjé soumis ses documents et est en attente
          ...
          <CardContent className="space-y-6">
            <div className="text-center p-6 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <p className="text-sm text-yellow-700">
                Vos documents d'identité ont été reéus et sont en cours d'examen. 
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm text-gray-600 space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs">
                  ...
                  <li>Activation compléte de votre compte</li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                <Button onClick={handleManualRefresh} disabled={seconds>0} className="bg-yellow-600 hover:bg-yellow-700 disabled:opacity-50">Rafraéchir statut</Button>
              </div>
              <p className="text-center text-[11px] text-gray-400">Vous recevrez un email dés que la vérification sera terminée.</p>
            </div>
          </CardContent>
        </Card>
      </motion.div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm text-gray-600">
                <h4 className="font-medium">Accés limité:</h4>
                <p className="text-xs text-gray-500">
                  En attendant la vérification, l'accés é certaines fonctionnalités est restreint.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Button 
                ...
                className="w-full"
              >
                Accés Limité au Tableau de Bord
              </Button>
            </div>
