...
/**
 * Ce script analyse les fichiers JavaScript/JSX et ajoute automatiquement
 * les importations manquantes pour les composants lucide-react, UI, services et hooks communs.
 */
...
const IMPORT_MAPPINGS = {
  ...
  'Button': { module: '../../../components/ui/button', type: 'named', relativePath: true },
  'Card': { module: '../../../components/ui/card', type: 'named', relativePath: true },
  'CardContent': { module: '../../../components/ui/card', type: 'named', relativePath: true },
  'CardHeader': { module: '../../../components/ui/card', type: 'named', relativePath: true },
  'CardTitle': { module: '../../../components/ui/card', type: 'named', relativePath: true },
  'CardDescription': { module: '../../../components/ui/card', type: 'named', relativePath: true },
  'Badge': { module: '../../../components/ui/badge', type: 'named', relativePath: true },
  'Label': { module: '../../../components/ui/label', type: 'named', relativePath: true },
  'Input': { module: '../../../components/ui/input', type: 'named', relativePath: true },
  'Tabs': { module: '../../../components/ui/tabs', type: 'named', relativePath: true },
  'TabsList': { module: '../../../components/ui/tabs', type: 'named', relativePath: true },
  'TabsTrigger': { module: '../../../components/ui/tabs', type: 'named', relativePath: true },
  'TabsContent': { module: '../../../components/ui/tabs', type: 'named', relativePath: true },
  'Select': { module: '../../../components/ui/select', type: 'named', relativePath: true },
  'SelectTrigger': { module: '../../../components/ui/select', type: 'named', relativePath: true },
  'SelectValue': { module: '../../../components/ui/select', type: 'named', relativePath: true },
  'SelectContent': { module: '../../../components/ui/select', type: 'named', relativePath: true },
  'SelectItem': { module: '../../../components/ui/select', type: 'named', relativePath: true },
  'Checkbox': { module: '../../../components/ui/checkbox', type: 'named', relativePath: true },
  'Textarea': { module: '../../../components/ui/textarea', type: 'named', relativePath: true },
  'Progress': { module: '../../../components/ui/progress', type: 'named', relativePath: true },
  'Avatar': { module: '../../../components/ui/avatar', type: 'named', relativePath: true },
  'AvatarFallback': { module: '../../../components/ui/avatar', type: 'named', relativePath: true },
  'LoadingSpinner': { module: '../../../components/ui/loading-spinner', type: 'named', relativePath: true },
  
  // Hooks et services
  'useToast': { module: '../../../components/ui/use-toast', type: 'named', relativePath: true },
  'useAuth': { module: '../../../hooks/useAuth', type: 'named', relativePath: true },
  'useRealtimeTable': { module: '../../../hooks/useRealtimeTable', type: 'named', relativePath: true },
  'SupabaseDataService': { module: '../../../services/SupabaseDataService', type: 'default', relativePath: true },
  'supabase': { module: '../lib/supabaseClient', type: 'default', relativePath: true },
...
// Function to adjust import paths based on file depth
function adjustImportPath(basePath, filePath, importPath) {
  if (!importPath.startsWith('..')) return importPath;
  
  const fileDir = path.dirname(filePath);
  const relativeDepth = path.relative(basePath, fileDir).split(path.sep).length;
  
  // Adjust the number of ../ based on the depth
  let adjustedPath = importPath;
  if (relativeDepth > 3) {
    adjustedPath = importPath.replace('../../../', '../'.repeat(relativeDepth));
    ...
    for (const [component, importInfo] of Object.entries(IMPORT_MAPPINGS)) {
      ...
      if (regex.test(content)) {
        ...
        if (!importRegex.test(content)) {
          const modulePath = importInfo.relativePath 
            ? adjustImportPath(basePath, filePath, importInfo.module) 
            : importInfo.module;
...
console.log('Analyzing and fixing files...');
