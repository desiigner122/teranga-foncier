...
// Removed unused __toESM helper function
...
        if (typeof callback === "function") callback(packet.value.error, {});
      } else {
        if (typeof callback === "function") callback(null, packet.value);
      }
    }
  };
...
          };
          if (errors.length > 0) {
            callback(failureErrorWithLog("Transform failed", errors, warnings), null);
            return;
          }
          if (response.codeFS) {
            outstanding++;
...
  let summary = "";
  if (errors.length > 0) {
    summary = ` with ${errors.length} error${errors.length < 2 ? "" : "s"}:` +
...
        root,
      // pnpapi = require("pnpapi"); // Commented out for ESM conversion suggestion
        ".cache",
        "esbuild",
